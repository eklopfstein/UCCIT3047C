<%------------------------------------------------------------------------------
 ...
 - IT3047C Spring 2020                                                         -
 - HTML for the assignment04-02 page                                           -
 - Takes user's card information for the billing info                          -
 - Also displays the info given on the last page in read-only                  -
-------------------------------------------------------------------------------%>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Assignment04-02.aspx.cs" Inherits="Assignment04_02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <main>
        ...
        <asp:TextBox ID="tbCard" runat="server">1234567893640129</asp:TextBox>
        <br />
        <asp:Label ID="lblExpire" runat="server" Text="Expiration Date: "></asp:Label>
        <asp:TextBox ID="tbExpire" runat="server">4/20</asp:TextBox>
        <br />
        <asp:Label ID="lblSecurity" runat="server" Text="Secuirty Code: "></asp:Label>
        <asp:TextBox ID="tbSecurity" runat="server">123</asp:TextBox>
        <br />
